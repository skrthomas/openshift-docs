...
* For more information on allowing pods to reference images across projects, see xref:../openshift_images/managing_images/using-image-pull-secrets.adoc#images-allow-pods-to-reference-images-across-projects_using-image-pull-secrets[Allowing pods to reference images across projects].
ifdef::openshift-enterprise,openshift-webscale,openshift-origin[]
